...
import 'package:spoonacular_app/custom/CustomIcons.dart';
import 'package:spoonacular_app/screens/meals_screen.dart';
...
import 'package:spoonacular_app/widgets/social_icon.dart';
    ...
    if (_formKey.currentState.validate()) {
      ...
      try {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SearchFoodScreen(user: user)));
      } catch (e) {
        print(e);
      }
    }
